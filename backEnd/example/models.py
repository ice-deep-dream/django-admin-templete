...
class MenuItem(models.Model):
    ...
    group_label = models.CharField(max_length=50, blank=True, null=True, verbose_name='分组标签')
...
class RoleMenu(models.Model):
    """角色-菜单关联表 - 控制哪些角色可以访问哪些菜单"""
    group = models.ForeignKey('auth.Group', on_delete=models.CASCADE, verbose_name='角色')
    ...
    def __str__(self):
        return f'{self.group.name} -> {self.menu_item.label}'
